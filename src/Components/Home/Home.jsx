...
import "./Home.css"
import {BsFillPersonFill,BsGlobe2,BsGearFill,BsSearch, BsArrowRightSquareFill} from 'react-icons/bs'
import Surah from './surah/Surah'
import { useNavigate } from 'react-router-dom'
import ReactModal from 'react-modal'
import Pages from '../Surahpages/Pages'
...
const selectedSurahs = surahs.filter(
  surah => [36, 18, 67, 56].includes(surah.number)
);

  

  useEffect(() => {
    // Filter the surahs based on the user's input
    const filteredSurahs = surahs.filter(surah => {
      const surahName = surah.englishName.toLowerCase();
      return surahName.includes(userInput);
    });

    // Update the filtered surahs state
        ...
        <div className="banner">
            ...
            <div className="qur-nav">
               ...
               <div className="qur-nav-button">
                <BsFillPersonFill onClick={()=>{navigate('/Login')}} />
      ...
      >
        <div>
          <div className='modal-search'>
            <BsSearch style={{ marginTop: "5px", color: "#777" }} />
            <input
              type="text"
              className='modal-inp'
          ...
          <div className="modal-body">
            <h5>Try Navigating to</h5>
            <div className="surahs-container">
            {userInput.length > 0 &&filteredSurahs.length > 0 ? (
              filteredSurahs.map((surah,index) => (
                <div className="modal-list"
                onClick={(event) => handleSurahClick(surah.number,event)} 
                key={index}>
                  <BsArrowRightSquareFill style={{ marginTop: "5px" }} />
                  <a href="">{surah.englishName}</a>
                </div>
